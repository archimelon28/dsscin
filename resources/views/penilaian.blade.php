      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            <form action="{{route('penilaian.store')}}" enctype="multipart/form-data" method="post" accept-charset="utf-8">
			{{ csrf_field() }}
            <div class="card-body">
              <div class="form-group">
                <label for="inputName">Bobot  UKT</label>
                <input type="text" id="inputName" name="ukt" class="form-control">
              </div>
            <div class="form-group">
                <label for="inputName">Bobot Akreditasi</label>
                <input type="text" id="inputName" name="akreditasi" class="form-control">
              </div>
              <div class="form-group">
                <label for="inputName">Bobot Sarana & Prasarana</label>
